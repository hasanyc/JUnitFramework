...
public class Mouse {
	...
	/*
	 * This function moves the mouse cursor has a delay before and after the move can be set to zero
	 */
	...
	/*
	 * This function moves the mouse cursor and presses the left button and releases
	 * This function has a delay at the end of the press and after the press can be set to zero
	 */
	...
	/*
	 * This function moves the mouse cursor and presses the right button and releases
	 * This function has a delay at the end of the press and after the press can be set to zero
	 */
	...
	/*
	 * This function scrolls the mouse wheel and and presses the left mouse button
	 */
	...
	/*
	 * This function scrolls the mouse wheel and and presses the right mouse button
	 */
